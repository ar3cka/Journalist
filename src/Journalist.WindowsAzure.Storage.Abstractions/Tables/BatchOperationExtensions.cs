...
namespace Journalist.WindowsAzure.Storage.Tables
{
    public static class BatchOperationExtensions
    {
        ...
        public static void Insert(this IBatchOperation batchOperation, string partitionKey)
        {
            Require.NotNull(batchOperation, "batchOperation");

            batchOperation.Insert(partitionKey, EmptyDictionary.Get<string, object>());
        }
        ...
        public static void Replace(this IBatchOperation batchOperation, string partitionKey, string etag)
        {
            Require.NotNull(batchOperation, "batchOperation");

            batchOperation.Replace(partitionKey, etag, EmptyDictionary.Get<string, object>());
        }
        ...
        public static void InsertOrMerge(this IBatchOperation batchOperation, string partitionKey)
        {
            Require.NotNull(batchOperation, "batchOperation");

            batchOperation.InsertOrMerge(partitionKey, EmptyDictionary.Get<string, object>());
        }
