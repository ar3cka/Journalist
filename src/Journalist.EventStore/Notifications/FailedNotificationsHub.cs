...
{
	public class FailedNotificationsHub : IFailedNotificationsHub
	{
		...
		private static readonly ILogger s_logger = Log.ForContext<FailedNotificationsHub>();

		public FailedNotificationsHub(ICloudTable failedNotificationsTable, INotificationFormatter notificationFormatter)
		{
